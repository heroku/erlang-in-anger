...
%%
%%% Psychomotor
%% nope, or through cognitive verifications
%%
...
%%%
%%% should rework to break up causes and solutions
%%%
...
%% - When should you keep the old items in a queue buffer? The new ones?
%% - 
%%
%% Analysis: break down info, make inferences, find evidence
%% - Give two examples of the type of state that can go in a process' init function
