...
This means that when you introduce synchronous behavior deep in the system, you'll possibly need to handle back-pressure, level by level, until you end up at the system's edges and can tell the user, "please slow down."
...
% TODO: The second sentence "Implicit back-pressure.." needs to be reworked or split into two sentences.
...
% TODO: "rather than trying to sort it all out in the end" is kinda vague. does this mean at the receiving queue? 
