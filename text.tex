...
\section{Background: Erlang's Memory Model}
...
%% keep adding content from https://blog.heroku.com/archives/2013/11/7/logplex-down-the-rabbit-hole
...
Erlang's memory is based 
% stack / old heap / total heap
...
Monitoring all garbage collections in real-time from the shell would be costly. Instead, looking at Erlang's system monitor...
